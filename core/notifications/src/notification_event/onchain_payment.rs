...
impl NotificationEvent for OnchainPayment {
    ...
    fn to_localized_push_msg(&self, locale: GaloyLocale) -> LocalizedPushMessage {
        let title = t!("onchain_payment.title", locale = locale.as_ref()).to_string();
        let body = t!("onchain_payment.body", locale = locale.as_ref()).to_string();
