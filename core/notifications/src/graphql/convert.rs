...
use super::types;
use crate::{in_app_channel, primitives::*, user_notification_settings};
...
impl From<in_app_channel::InAppNotification> for types::InAppNotification {
    fn from(notification: in_app_channel::InAppNotification) -> Self {
        Self {
