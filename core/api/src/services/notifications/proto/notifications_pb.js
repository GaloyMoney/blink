...
goog.exportSymbol('proto.services.notifications.v1.LocalizedPushContent', null, global);
 ...
 * @constructor
 */
proto.services.notifications.v1.LocalizedPushContent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.notifications.v1.LocalizedPushContent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.notifications.v1.LocalizedPushContent.displayName = 'proto.services.notifications.v1.LocalizedPushContent';
}
...
proto.services.notifications.v1.MarketingNotificationTriggered.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = msg.getLocalizedPushContentMap();
...
/**
 * map<string, LocalizedPushContent> localized_push_content = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.services.notifications.v1.LocalizedPushContent>}
 */
proto.services.notifications.v1.MarketingNotificationTriggered.prototype.getLocalizedPushContentMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.services.notifications.v1.LocalizedPushContent>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      proto.services.notifications.v1.LocalizedPushContent));
};
 ...
 * @return {!Object}
 */
proto.services.notifications.v1.LocalizedPushContent.prototype.toObject = function(opt_includeInstance) {
  return proto.services.notifications.v1.LocalizedPushContent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.notifications.v1.LocalizedPushContent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.notifications.v1.LocalizedPushContent.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.notifications.v1.LocalizedPushContent}
 */
proto.services.notifications.v1.LocalizedPushContent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.notifications.v1.LocalizedPushContent;
  return proto.services.notifications.v1.LocalizedPushContent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.notifications.v1.LocalizedPushContent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.notifications.v1.LocalizedPushContent}
 */
proto.services.notifications.v1.LocalizedPushContent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.notifications.v1.LocalizedPushContent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.notifications.v1.LocalizedPushContent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.notifications.v1.LocalizedPushContent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.notifications.v1.LocalizedPushContent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTitle();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.services.notifications.v1.LocalizedPushContent.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.notifications.v1.LocalizedPushContent} returns this
 */
proto.services.notifications.v1.LocalizedPushContent.prototype.setTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.services.notifications.v1.LocalizedPushContent.prototype.getBody = function() {
 ...
 * @return {!proto.services.notifications.v1.LocalizedPushContent} returns this
 */
proto.services.notifications.v1.LocalizedPushContent.prototype.setBody = function(value) {
