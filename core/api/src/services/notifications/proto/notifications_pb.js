...
goog.exportSymbol('proto.services.notifications.v1.IdentityVerificationReviewPending', null, global);
 ...
 * @constructor
 */
proto.services.notifications.v1.IdentityVerificationReviewPending = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.notifications.v1.IdentityVerificationReviewPending, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.notifications.v1.IdentityVerificationReviewPending.displayName = 'proto.services.notifications.v1.IdentityVerificationReviewPending';
}
 ...
 * @const
 */
proto.services.notifications.v1.NotificationEvent.oneofGroups_ = [[1,2,3,4,5]];
...
proto.services.notifications.v1.NotificationEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    identityVerificationReviewPending: (f = msg.getIdentityVerificationReviewPending()) && proto.services.notifications.v1.IdentityVerificationReviewPending.toObject(includeInstance, f)
  };
...
proto.services.notifications.v1.NotificationEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.services.notifications.v1.IdentityVerificationReviewPending;
      reader.readMessage(value,proto.services.notifications.v1.IdentityVerificationReviewPending.deserializeBinaryFromReader);
      msg.setIdentityVerificationReviewPending(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.services.notifications.v1.NotificationEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getIdentityVerificationReviewPending();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
...
/**
 * optional IdentityVerificationReviewPending identity_verification_review_pending = 5;
 * @return {?proto.services.notifications.v1.IdentityVerificationReviewPending}
 */
proto.services.notifications.v1.NotificationEvent.prototype.getIdentityVerificationReviewPending = function() {
  return /** @type{?proto.services.notifications.v1.IdentityVerificationReviewPending} */ (
    jspb.Message.getWrapperField(this, proto.services.notifications.v1.IdentityVerificationReviewPending, 5));
};


/**
 * @param {?proto.services.notifications.v1.IdentityVerificationReviewPending|undefined} value
 * @return {!proto.services.notifications.v1.NotificationEvent} returns this
*/
proto.services.notifications.v1.NotificationEvent.prototype.setIdentityVerificationReviewPending = function(value) {
 ...
 * @return {!proto.services.notifications.v1.NotificationEvent} returns this
 */
proto.services.notifications.v1.NotificationEvent.prototype.clearIdentityVerificationReviewPending = function() {
  return this.setIdentityVerificationReviewPending(undefined);
};
 ...
 * @return {boolean}
 */
proto.services.notifications.v1.NotificationEvent.prototype.hasIdentityVerificationReviewPending = function() {
 ...
 * @return {!Object}
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.prototype.toObject = function(opt_includeInstance) {
  return proto.services.notifications.v1.IdentityVerificationReviewPending.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.notifications.v1.IdentityVerificationReviewPending} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * @return {!proto.services.notifications.v1.IdentityVerificationReviewPending}
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.notifications.v1.IdentityVerificationReviewPending;
  return proto.services.notifications.v1.IdentityVerificationReviewPending.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.notifications.v1.IdentityVerificationReviewPending} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.notifications.v1.IdentityVerificationReviewPending}
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.notifications.v1.IdentityVerificationReviewPending.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.notifications.v1.IdentityVerificationReviewPending} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.notifications.v1.IdentityVerificationReviewPending} returns this
 */
proto.services.notifications.v1.IdentityVerificationReviewPending.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
