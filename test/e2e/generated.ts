...
/** Initiation leaders */
export type InitiationLeaders = {
  readonly __typename: 'InitiationLeaders';
  readonly leaders: ReadonlyArray<Scalars['String']['output']>;
};
...
export type Query = {
  ...
  readonly initiationLeaders?: Maybe<InitiationLeaders>;
