...
export class CustomError extends ApolloError {
  ...
  constructor({
    ...
    level,
    ...metadata
  }: CustomErrorData & { code: string; message?: string }) {
...
export class TransactionRestrictedError extends CustomError {
  constructor(errData: CustomErrorData) {
    super({ ...errData, code: "TRANSACTION_RESTRICTED" })
  }
}

export class InsufficientBalanceError extends CustomError {
  constructor(errData: CustomErrorData) {
    super({ code: "INSUFFICIENT_BALANCE", message: "balance is too low", ...errData })
  }
}

export class SelfPaymentError extends CustomError {
  constructor(errData: CustomErrorData) {
    super({ code: "CANT_PAY_SELF", message: "User tried to pay themselves", ...errData })
  }
}

export class ValidationInternalError extends CustomError {
  constructor(errData: CustomErrorData) {
    super({ code: "INVALID_INPUT", ...errData })
  }
}

export class NotFoundError extends CustomError {
  constructor(errData: CustomErrorData) {
    super({ code: "NOT_FOUND", ...errData })
  }
}

export class NewAccountWithdrawalError extends CustomError {
  constructor(errData: CustomErrorData) {
    super({ code: "NEW_ACCOUNT_WITHDRAWAL_RESTRICTED", ...errData })
  }
}

export class TooManyRequestError extends CustomError {
  constructor(errObj: CustomErrorData) {
    super({
...
export class DbError extends CustomError {
  constructor(errObj: CustomErrorData) {
    super({ code: "DB_ERROR", forwardToClient: true, ...errObj })
  }
}
