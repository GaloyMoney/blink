...
import { kratosPublic, validateKratosToken } from "@services/kratos"
...
// used by oathkeeper to validate LegacyJWT and KratosSessionToken
  ...
  wrapAsyncToRunInSpan({
    ...
    fn: async (req: any, res: any) => {
      ...
      if (rawToken.length === 32) {
        const kratosRes = await validateKratosToken(rawToken as KratosSessionToken)
