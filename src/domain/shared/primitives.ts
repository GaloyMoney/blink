...
export const satsFromBtcPaymentAmount = (btcPaymentAmount: BtcPaymentAmount): Satoshis => {
  return Number(btcPaymentAmount.amount) as Satoshis
}

export const centsFromUsdPaymentAmount = (usdPaymentAmount: UsdPaymentAmount): UsdCents => {
