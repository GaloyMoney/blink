...
export const decodeInvoice = (
  ...
  const amount: Satoshis | undefined = decodedInvoice.tokens
    ? toSats(BigInt(decodedInvoice.tokens))
    : undefined
  ...
  return {
    ...
    milliSatsAmount: toMilliSatsFromBigInt(decodedInvoice.mtokens || 0),
