...
export class CreateBearerTokenIpRateLimiterExceededError extends RateLimiterExceededError {}
export class CreateBearerTokenGlobalRateLimiterExceededError extends RateLimiterExceededError {}
