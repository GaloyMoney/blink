...
/**
 * __useGetUsdWalletIdQuery__
 *
 * To run a query within a React component, call `useGetUsdWalletIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsdWalletIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsdWalletIdQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetUsdWalletIdQuery(baseOptions?: Apollo.QueryHookOptions<GetUsdWalletIdQuery, GetUsdWalletIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUsdWalletIdQuery, GetUsdWalletIdQueryVariables>(GetUsdWalletIdDocument, options);
      }
export function useGetUsdWalletIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsdWalletIdQuery, GetUsdWalletIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUsdWalletIdQuery, GetUsdWalletIdQueryVariables>(GetUsdWalletIdDocument, options);
        }
export type GetUsdWalletIdQueryHookResult = ReturnType<typeof useGetUsdWalletIdQuery>;
export type GetUsdWalletIdLazyQueryHookResult = ReturnType<typeof useGetUsdWalletIdLazyQuery>;
export type GetUsdWalletIdQueryResult = Apollo.QueryResult<GetUsdWalletIdQuery, GetUsdWalletIdQueryVariables>;
