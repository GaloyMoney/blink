...
helm install --namespace=$NAMESPACE bitcoind --set service.type=$SERVICETYPE -f ../../bitcoind-chart/values.yaml -f ../../bitcoind-chart/regtest-values.yaml ../../bitcoind-chart/
